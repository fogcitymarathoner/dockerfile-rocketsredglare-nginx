    ...
    server {
       server_name www.ut.fogtest.com;
       #rewrite ^(.*) http://www.fogtest.com$1 permanent;

    return 301 $scheme://ut.fogtest.com$request_uri;
    }
	...
	root /home/marc/python_apps/jqfogtest;
        ...
        server_name  ut.fogtest.com;

        access_log /var/log/nginx/ut.access.log;
        error_log /var/log/nginx/ut.error.log;
        ...
        location /static {
                autoindex on;
                alias /var/www/ut.fogtest.com.static;
        }

        location / {
           proxy_pass         http://ut_app;
           proxy_redirect     off;
