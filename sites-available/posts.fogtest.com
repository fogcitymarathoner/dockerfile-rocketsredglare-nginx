    ...
    server {
       server_name www.posts.fogtest.com;
       #rewrite ^(.*) http://www.fogtest.com$1 permanent;

    return 301 $scheme://posts.fogtest.com$request_uri;
    }
	...
	root /home/marc/python_apps/jqfogtest;
        ...
        server_name  posts.fogtest.com;

        access_log /var/log/nginx/posts.access.log;
        error_log /var/log/nginx/posts.error.log;
        ...
        location /static {
                autoindex on;
                alias /var/www/posts.fogtest.com.static;
        }

        location / {
           proxy_pass         http://posts_app;
           proxy_redirect     off;
