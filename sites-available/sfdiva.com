    ...
    server {
       server_name www.sfdiva.com;
       #rewrite ^(.*) http://www.sfgeek.net$1 permanent;

    return 301 $scheme://sfdiva.com$request_uri;
    }

    server {
        listen       80;

	root /home/marc/python_apps/sfdiva_com;

        server_name  sfdiva.com;
        ...
        location /static {
                autoindex on;
                alias /home/marc/python_apps/sfdiva_com/static/;
        }


        location / {
                include uwsgi_params;
                uwsgi_pass localhost:8096;
        }
