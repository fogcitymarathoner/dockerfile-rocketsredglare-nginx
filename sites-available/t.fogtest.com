    ...
    server {
       server_name www.t.fogtest.com;
       #rewrite ^(.*) http://www.sfgeek.net$1 permanent;

    return 301 $scheme://t.fogtest.com$request_uri;
    }

    server {
        listen       80;

	root /home/marc/python_apps/tfogtest;

        server_name  t.fogtest.com;

        access_log /var/log/nginx/t.access.log;
