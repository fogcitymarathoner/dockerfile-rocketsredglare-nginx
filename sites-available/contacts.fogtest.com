    ...
    upstream contacts_app {
         server 127.0.0.1:8114;
    }

    server {
       server_name www.contacts.fogtest.com;
       #rewrite ^(.*) http://www.fogtest.com$1 permanent;

    return 301 $scheme://contacts.fogtest.com$request_uri;
    }
	...
	root /home/marc/python_apps/jqfogtest;
        ...
        server_name  contacts.fogtest.com;
        ...
        location /docs {
                autoindex on;
                alias /home/marc/python_test_apps/contacts_docs/static/docs;
        }
        location /static {
                autoindex on;
                alias /var/www/contacts.fogtest.com.static;
        }

        location / {
           proxy_pass         http://contacts_app;
           proxy_redirect     off;
