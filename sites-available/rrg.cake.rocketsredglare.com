    ...
    server {
       server_name www.rrg.cake.rocketsredglare.com;
       #rewrite ^(.*) http://www.fogtest.com$1 permanent;

    return 301 $scheme://rrg.cake.rocketsredglare.com$request_uri;
    }
	...
	root /home/marc/python_apps/jqfogtest;
        ...
        server_name  rrg.cake.rocketsredglare.com;

        access_log /var/log/nginx/rrg.cake.access.log;
        error_log /var/log/nginx/rrg.cake.error.log;
        ...
        location /static {
                autoindex on;
                alias /var/www/rrg.cake.rocketsredglare.com.static;
        }

        location / {
           proxy_pass         http://djrrg_app;
           proxy_redirect     off;
