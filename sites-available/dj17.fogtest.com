    ...
    server {
       server_name www.dj17.fogtest.com;
       #rewrite ^(.*) http://www.fogtest.com$1 permanent;

    return 301 $scheme://dj17.fogtest.com$request_uri;
    }
	...
	root /home/marc/python_apps/jqfogtest;
        ...
        server_name  dj17.fogtest.com;

        access_log /var/log/nginx/dj17.access.log;
        error_log /var/log/nginx/dj17.error.log;
        ...
        location /static {
                autoindex on;
                alias /var/www/dj17.fogtest.com.static;
        }

        location / {
           proxy_pass         http://dj17_app;
           proxy_redirect     off;
